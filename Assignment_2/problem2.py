...
class Node():
    ...
    def __init__(self, id: str):
        ...
        self.known_colours = []
        self.neighbours = []
        self.personality = random.choice([0, 1, 2]) # personality type
        self.strength = random.random() # personality strength
            ...
            if self.colour == neighbour.get_colour():
                ...
                if self.personality == 0 and neighbour.personality == 0:
                    ...
                    if self.strength > neighbour.strength:
                        ...
                        self.change_colour()
                elif (self.personality == 0 and neighbour.personality == 1) or (self.personality == 0 and neighbour.personality == 2):
                    # aggressive vs assertive or passive
                    neighbour.change_colour()
                    ...
                    self.change_colour()
                elif self.personality == 1 and neighbour.personality == 2:
                    neighbour.change_colour()
                elif self.personality == 2 and neighbour.personality == 2:
                    # check strength
                    if self.strength > neighbour.strength:
                        neighbour.change_colour()
                    else:
                        self.change_colour()
                elif self.personality == 2 and neighbour.personality == 0:
                    self.change_colour()
                elif self.personality == 2 and neighbour.personality == 1:
                    self.change_colour()     
            else:
                pass
